...
<body <?php body_class(); ?>>
    <div id="pageholder">
        ...
        <div id="slider" class="nivoSlider">
            ...
            <?php }else{ ?>
            <img src="<?php echo esc_url( get_template_directory_uri() ) ; ?>/images/slides/slider-default.jpg"
                title="#slidecaption<?php echo $i; ?>" />
            <?php } ?>
            <?php $i++; }  ?>
        </div>
        <?php 
        ...
        <div class="container">
            <div class="services-wrap">
                ...
                <div class="fourbox <?php if($p % 3 == 0) { echo "last_column"; } ?>">
                    ...
                    <div class="thumbbx"><a
                            href="<?php echo esc_url( get_permalink() ); ?>"><?php the_post_thumbnail();?></a></div>
                    <?php } ?>
